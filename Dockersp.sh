...
start_menu(){
    ...
    green "11.【同步盘】Seafile		24.【同步盘】syncthing		35.【祥云发卡】"		
    green "———————————————————————————————————---->>博客类程序<<----—————————————————————————————————"
    green "6.【GRAV】博客			18.【Wiki】随身笔记		33.【heimdall】导航"
    green "7.【Wordpress】博客		19.【Typecho】博客		36.【z发卡】"
    green "8.【RSS订阅器】		20.【Halo】 博客		37.骗子查询		38.Malio	39.Kodexplorer 40.【Fiora 聊天室】 41.【青龙面板】"  
    green "———————————————————————————————————---->>其他类型<<----——————————————————————————————————"
